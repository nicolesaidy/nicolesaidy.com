...
document.querySelector('.product-imgWrapper').addEventListener('mouseover', function(event){
    img2.setAttribute('transform', 'translate(180, 32)');
    img3.setAttribute('transform', 'translate(400, 0)');
});
document.querySelector('.product-imgWrapper').addEventListener('mouseout', function(event){
    img2.setAttribute('transform', 'translate(150, 32)');
    img3.setAttribute('transform', 'translate(305, 0)');
});
